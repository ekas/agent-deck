...
Aufloesung + der State-Ordner wohnen jetzt in hookstate/deck_paths.
"""
import os
import sys
import json
...
def main():
    ...
    dst = deck_paths.state_path(slot)
    prev = deck_paths.load_json(dst, {}) or {}
    ...
    deck_paths.save_json(dst, rec)   # atomar: .tmp + os.replace
