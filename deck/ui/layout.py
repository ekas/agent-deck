...
class LayoutMixin:
    ...
    def _apply_slim_layout(self) -> None:
    ...
    def _sync_ui_scale(self, redraw=True) -> Any:
    ...
    def _fit_slim_window(self, scale) -> None:
    ...
    def _on_deck_configure(self, ev) -> None:
